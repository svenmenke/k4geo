#ifndef DETSEGMENTATION_ENDCAPPARALLELPLATETURBINE_H
#define DETSEGMENTATION_ENDCAPPARALLELPLATETURBINE_H
...
/** FCCSWEndcapParallelPlateTurbine_k4geo
 *
 *  Segmentation for parallel-plate turbine-style endcap calorimeter
 *
 */

namespace dd4hep {
namespace DDSegmentation {
  class FCCSWEndcapParallelPlateTurbine_k4geo : public Segmentation {
  public:
    /// default constructor using an arbitrary type
    FCCSWEndcapParallelPlateTurbine_k4geo(const std::string& aCellEncoding);
    /// Default constructor used by derived classes passing an existing decoder
    FCCSWEndcapParallelPlateTurbine_k4geo(const BitFieldCoder* decoder);
    /// common setup that needs to be done for either of the above constructors
    void commonSetup();
    /// destructor
    virtual ~FCCSWEndcapParallelPlateTurbine_k4geo() = default;
    ...
    /** Get the grid size in rho
     * return grid size in rho
     */
    inline double gridSizeRho() const { return m_gridSizeRho; }

    /** Get the number of cells in rho
     * return number of cells in rho
     */
    inline int numCellsRho() const { return m_numReadoutRhoLayers; }
    ...
    /** Get the angle of the groups 
     *  return the angle of the groups
     */
    double groupAngle() const { return m_groupAngle; }
    ...
    /**  Set the field name used for the slice ID.
     *   @param[in] aFieldName Field name for slice.
     */
    inline void setFieldNameSlice(const std::string& fieldName) { m_sliceID = fieldName; }
    ...
    /** Get the grid size in z
     * return grid size in z
     */
    inline double gridSizeZ() const { return m_gridSizeZ; }

    /** Get the number of cells in z
     * return number of cells in z
     */
    inline int numCellsZ() const { return m_numReadoutZLayers; }
     ...
     */
    inline int nGroups() { return m_nGroups; }
  ...
  protected:
    ...
    /// number of groups
    int m_nGroups;
    /// the number of cells in rho
    int m_numReadoutRhoLayers;
    /// the number of cells in z
    int m_numReadoutZLayers;
    ...
    /// the field name used for stack
    std::string m_stackID;
    /// the field name used for group
...
#endif /* DETSEGMENTATION_ENDCAPPARALLELPLATETURBINE_H */
